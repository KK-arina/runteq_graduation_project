...
ActiveRecord::Schema[7.2].define(version: 2026_07_09_121117) do
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.index ["terms_agreed_at"], name: "index_users_on_terms_agreed_at", where: "(terms_agreed_at IS NOT NULL)"
  end
