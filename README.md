...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-23%2F67_ISSUE-f59e0b?style=flat-square)]()
...
│   │   └── purpose_analysis_job.rb        # #D-1 新規: PMVV AI分析ジョブ（D-2スタブ・analysis_state を analyzing に変更するのみ）
│   ├── mailers/
