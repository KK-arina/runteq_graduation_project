...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-41%2F67_ISSUE-f59e0b?style=flat-square)]()
...
| OmniAuth LINE | ソーシャルログイン（LINE） | #F-2 | ⬜ 未着手 |
...
│   │   └── omniauth_callbacks_controller.rb   # F-1 新規: Google OAuth2 コールバック（google / failure アクション）
│   ├── models/
