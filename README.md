...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-24%2F67_ISSUE-f59e0b?style=flat-square)]()
...
│       │   ├── _voice_field.html.erb      # #D-1 新規: 音声入力付きテキストエリアパーシャル（DRY化）
        │   └── _analysis_status_banner.html.erb  # #D-2 新規: 分析状態バナーパーシャル（Turbo Stream target・4状態切替）
│       └── layouts/
...
### API gem が存在しない場合は REST API を直接呼ぶ
...
### ActiveRecord の予約語はカラム名に使ってはいけない
...
### AI クライアントは戻り値に使用モデル名を含めて正確に記録する
