...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-48%2F68_ISSUE-f59e0b?style=flat-square)]()
...
│       ├── settings/
│       │   └── show.html.erb              # F-6 新規: アカウント設定ページ（M-4 退会確認モーダル・削除/保持データ明示・onclick でDOM直接操作）
│       ├── password_resets/
...
```
667 runs, 1654 assertions, 0 failures, 0 errors, 0 skips
