...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-49%2F68_ISSUE-f59e0b?style=flat-square)]()
...
│   │   └── user_settings_controller.rb    # G-3 新規: notification_settings（GET）/ update_notification_settings（PATCH）・before_action :require_login・303 See Other リダイレクト
│   ├── models/
...
│       ├── settings/
│       │   └── show.html.erb              # F-6 新規・G-3 変更: 通知設定リンクカードを追加（LINE連携状況バッジ付き）
│       ├── user_settings/
...
```
675 runs, 1678 assertions, 0 failures, 0 errors, 0 skips
