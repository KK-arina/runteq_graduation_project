...
[![本リリース進捗](https://img.shields.io/badge/本リリース進捗-46%2F68_ISSUE-f59e0b?style=flat-square)]()
...
│   │   └── notification_service.rb        # E-4 新規: LINE/メール通知の共通サービス（deep_link_url 埋め込み・app_host DRY化・G-1実装後に拡張予定）
│   ├── javascript/
│   │   └── controllers/
...
```
652 runs, 1593 assertions, 0 failures, 0 errors, 0 skips
